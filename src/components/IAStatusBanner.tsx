...
export function IAStatusBanner({
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-[hsl(265_85%_60%/0.35)] bg-gradient-to-br from-[hsl(265_45%_12%)] via-[hsl(220_25%_8%)] to-[hsl(160_45%_10%)] p-5 shadow-[0_0_32px_hsl(265_85%_50%/0.18)]">
      {/* Pulsing aura */}
      ...
      <div className="pointer-events-none absolute -bottom-20 -right-10 h-56 w-56 rounded-full bg-[hsl(160_84%_45%/0.15)] blur-3xl animate-pulse" />
      ...
      <div className="relative">
        ...
        <div className="flex items-center gap-2.5">
          <span className="relative flex h-3 w-3">
            ...
            <span className="relative inline-flex h-3 w-3 rounded-full bg-[hsl(160_84%_50%)]" />
          </span>
          <Activity className="h-4 w-4 text-[hsl(160_84%_55%)]" />
          <h3 className="text-lg font-extrabold uppercase tracking-wider text-foreground sm:text-xl">
            IA Operando<span className="ml-1 inline-flex animate-pulse text-[hsl(160_84%_55%)]">...</span>
          </h3>
          {paused && (
        ...
        <div className="mt-4 flex flex-wrap items-end justify-between gap-3">
          ...
          <div className="flex flex-col items-end gap-1 text-xs ct-mono">
            <div className="text-[hsl(160_84%_55%)]">
        ...
        <div className="mt-4">
          <div className="mb-1 flex items-center justify-between text-[10px] font-semibold uppercase tracking-wider">
            ...
            <span className="text-[hsl(160_84%_55%)]">Meta</span>
          </div>
          <div className="relative h-2.5 w-full overflow-hidden rounded-full bg-[hsl(220_25%_4%)] ring-1 ring-border/40">
            ...
            {positive ? (
              <div
                className="absolute left-1/2 top-0 h-full rounded-r-full bg-gradient-to-r from-[hsl(160_84%_45%)] to-[hsl(160_84%_55%)] shadow-[0_0_10px_hsl(160_84%_45%/0.6)] transition-all duration-500"
                style={{ width: `${pct / 2}%` }}
              />
            ) : (
              <div
