...
// Procurando = tela real (da8d3df). Operando = tela real: hero (40bfabe) + lista ao vivo (85df0f2) + list header (14fde8b). Pausado = FEITO (38d4859, Fatia 4: EM ESPERA + card RETOMAR + badge ⏸ como estado do Operando via `paused`). Resultado = FEITO (b0f47c9, Fatia 5: ResultadoScreen — Sessão encerrada + saldo + 2 textos por demoEndedManually + rodapé FECHAR/DEPOSITAR).
